...
class FragmentExplor : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val listitems = arrayListOf<itempost>(
        ...
        val myadapter = AdapterExplore(listitems)
