...
import ir.dunijet.wikipedia.adapters.AdapterTrend
...
class FragmentTrend : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val myadapter = AdapterTrend(dataTrend)
        binding.recyclerMainTrend.adapter = myadapter
        binding.recyclerMainTrend.layoutManager = LinearLayoutManager(context, RecyclerView.VERTICAL, false)
